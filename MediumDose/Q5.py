...
def _3dto4d(x, y, z):
    ...
    w4 = round(cx * cy * cz + sx * sy * sz, 5)
    x4 = round(sx * cy * cz - cx * sy * sz, 5)
    y4 = round(cx * sy * cz + sx * cy * sz, 5)
    z4 = round(cx * cy * sz - sx * sy * cz, 5)

    return w4, x4, y4, z4


x, y, z = input("Enter your 3'd coordinates : ").split()
x, y, z = int(x), int(y), int(z)

w4, x4, y4, z4 = _3dto4d(x, y, z)

print(f"Quaternion Coordinates : {w4} + {x4}i + {y4}j + {z4}k")
